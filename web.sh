...
python /home/user/Documents/editor/app2web.py --data_dir $data_dir/ --port=5002 --usegpu=true --reduce_gpu=true --web=true --forward_only=true 2>&1 | tee -a $data_dir/log/weblog.txt